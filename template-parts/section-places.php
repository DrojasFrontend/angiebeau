        ...
        <div class="sectionCartagena__slick" id="<?php echo $category['id']; ?>">
            ...
            <div class="sectionCartagena__wrapper">
                <div class="sectionCartagena__icon">
                    ...
                    <div>
                        <h2 class="heading--42 color--A98417 stroke--2 spacing--42 uppercase"><?php echo $category['title_es']; ?></h2>
                ...
                <?php foreach ($category['places'] as $place) { ?>
                    <div class="sectionCartagena__card">
                        <div class="sectionCartagena__padding">
                            ...
                            <h2 class="heading--22 stroke--0 spacing--22 color--154B54 uppercase">
                                <?php echo $place['name']; ?>
                            </h2>
        
                            <?php if ($place['address']) : ?>
                            <p class="heading--10 color--545453"><?php echo $place['address']; ?></p>
                            <?php endif?>
        
                            <?php if ($place['city']) : ?>
                            <p class="heading--10 color--545453 spacing--0"><?php echo $place['city']; ?></p>
                            <?php endif?>
        
                            <div class="space space--20"></div>
        
                            <?php if ($place['phone']) : ?>
                            <p class="heading--14 color--545453 stroke--0"><?php echo $place['phone']; ?></p>
                            <?php endif?>
        
                            <div class="space space--20"></div>
        
                            <?php if ($place['link']) : ?>
                                <a class="button button--small button--center color--154B54 stroke--0" href="<?php echo $place['link']; ?>" target="_blank">
                                    VER
                                </a>
                            <?php endif; ?>
                            </div>
