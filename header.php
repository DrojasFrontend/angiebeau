...
<head>
  ...
  <meta property="og:image" content="/wp-content/themes/theme-angiebeau/img/img-3.webp" />
  <meta name="twitter:image" content="/wp-content/themes/theme-angiebeau/img/img-3.webp" />
...
<header class="header <?php if(is_page('gift') || is_page('story')) { ?>active<?php } ?>" data-header>
  ...
  <nav>
    <ul class="header__menu">
      <li><a data-link class="header__link" href="/#wedding">NUESTRA BODA</a></li>
      <li><a data-link class="header__link" href="/#events">EVENTOS</a></li>
      <!-- <li><a data-link class="header__link" href="/#baru">BARÚ</a></li> -->
